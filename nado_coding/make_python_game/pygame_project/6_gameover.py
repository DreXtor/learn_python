    ...
    for ball_index, ball_val in enumerate(balls):
        ...
        for weapon_index, weapon_val in enumerate(weapons):
            ...
            if weapon_rect.colliderect(ball_rect):
                ...
                ball_to_remove = ball_index         # 공 없애기 위한 값 설정

                if ball_image_index < 3:        # 가장 작은 크기의 공이 아니라면 다음단계의 공으로 나누어주기
                    small_ball_size = ball_images[ball_image_index +
                                                  1].get_rect().size
                    ...
                    balls.append({
                        ...
                        "img_index": ball_image_index + 1,    # 공의 종류
                        "to_x": -3,      # 공의 x 축 이동방향
                        "to_y": -6,      # 공의 y 축 이동방향
                        # 공의 y 최초 속도 정의
